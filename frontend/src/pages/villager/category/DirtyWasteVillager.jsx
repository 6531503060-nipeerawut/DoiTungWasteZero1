...
function DirtyWasteVillager() {
  ...
  useEffect(() => {
    const fetchAuthStatus = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/v/dirtywastevillager`, { withCredentials: true });
...
export default DirtyWasteVillager;
