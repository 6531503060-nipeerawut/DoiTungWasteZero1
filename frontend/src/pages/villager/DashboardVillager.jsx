...
function DashboardVillager() {
    document.title = "Dashboard (ชาวบ้านและหน่วยงาน) - DoiTung Zero-Waste";
    ...
    useEffect(() => {
        const verifyUser = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/v/verify`, {
    ...
    useEffect(() => {
        const fetchLocations = async () => {
            if (dataSet === 'village' || dataSet === 'agency') {
                try {
                    const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/v/dashboard-locations`, {
                        params: { type: dataSet },
                        withCredentials: true
                    });
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/v/dashboard`, {
                    params: {
                        dataSet,
                        locationId,
                        mode,
