...
import Header from '../../components/Header'; // ปรับ path ตามโครงสร้างจริง
...
import { 
    ...
    WaterDrop as WaterDropIcon // ไอคอนสำหรับขยะเปียก
...
const themeColors = {
    ...
    // สีเฉพาะของวันจันทร์ (เหลืองทอง/Yellow Gold)
    dayColor: '#FBC02D',   
    dayBg: '#FFF9C4'       
};
...
function MondaySchedule() {
    ...
    useEffect(() => {
        // API Call (ถ้ามี Logic เก็บสถิติการเข้าชม)
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/v/mondayvillager`)
