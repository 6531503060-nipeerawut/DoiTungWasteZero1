...
function BigGarbagevillager() {
  ...
  useEffect(() => {
    const fetchAuthStatus = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/v/bigwastevillager`, { withCredentials: true });
...
export default BigGarbagevillager;
