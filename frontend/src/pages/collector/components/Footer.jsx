        ...
        >
            ...
            >
                ...
                <NavButton 
                    ...
                    icon={<HomeIcon />} 
                    label="หน้าหลัก" 
                    active={isActive('/c/homecollector')} 
                ...
                {/* 2. รายการ */}
                <NavButton 
                    to="/c/wastedatacollector" 
                    icon={<TrashIcon />} 
                    label="รายการ" 
                    active={isActive('/c/wastedatacollector')} 
                    activeColor={ACTIVE_COLOR} 
                    inactiveColor={INACTIVE_COLOR} 
                />
                ...
                <NavButton 
                    to="/c/addingwastecollector"
                    icon={<AddCircleIcon />} 
                    label="บันทึก"
                    active={isActive('/c/addingwastecollector')}
